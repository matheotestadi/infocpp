...
int tabl[5] = {2,7,8,9,1};//valeur
int tablo[5] = {4,4,4,4,4}; //1 = trefle; 2 = coeur; 3 = carreau; 4 = pique
...
void Carre(int tab[], int taille){
    ...
    for (i3=0 ; i3 < SIZE; i3++){
        if(tab[i3] == tab[i3+1] && tab[i3] == tab[i3+2] && tab[i3] == tab[i3+3] && tab[i3] == tab[i3+4]){
            carre = tab[i3];
            carreValide = 1;
        }
    }
...
void quintflushRoyal(int tab[], int tab2[], int taille){
    if(royal == 1){
        for(int i = 0; i < 5; i++){
            if(tab[i] == 14 && tab[i+1] == 13 && tab[i+2] == 12 && tab[i+3] == 11 && tab[i+4] == 10 && tab2[i] == tab2[i+1] && tab2[i] == tab2[i+2] && tab2[i] == tab2[i+3] && tab2[i] == tab2[i+4]){
